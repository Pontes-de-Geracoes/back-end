 ...
 * User person1 = new User("theo", 21, "voluntario", "theo@theo.com",
 * "theozin123", "remoto", "araxa", "mg", Set.of(necessity1));
 * User person2 = new User("laura", 98, "idoso", "laura@laura.com",
 * "laurinha123", "presencial", "sao jose do rio preto", "sp",
 * Set.of(necessity1));
 * 
 ...
 * try{
 * date = new
 * SimpleDateFormat("dd/mm/yyyy hh:mm:ss").parse("09/12/2024 10:00:00");
 * }catch(Exception e){
 ...
 * "}";
 * 
 * Meeting newMeeting = new Meeting(date, city, state, inPerson, description,
 * participants);
